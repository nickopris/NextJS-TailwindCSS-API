...
export const metadata = {
    title: 'TailwindCSS NextJS API demo',
    description: '',
}
    ...
    return (
        <html lang="en">
            <body>
                    ...
                    <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                        <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                            <a href="/" class="flex items-center">
                                <img src="./next.svg" class="h-6 mr-3 sm:h-9" alt="Landwind Logo" />
                            </a>
                ...
                {children}
                <footer class="class=grid gap-16 grid-cols-fluid max-w-screen-xl px-4 pt-20 pb-8 mx-auto">
                    <h5>Footer</h5>
